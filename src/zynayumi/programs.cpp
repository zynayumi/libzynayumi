...
Programs::Programs(Zynayumi& zynayumi)
{
	...
	prmtrs->patch.playmode = zynayumi::PlayMode::Poly;
	prmtrs->patch.tone.reset = false;
	prmtrs->patch.tone.phase = 0.1;
	prmtrs->patch.tone.time = std::numeric_limits<float>::infinity();
	prmtrs->tone_detune = 0.1;
	prmtrs->tone_transpose = -12;
	prmtrs->patch.tone.spread = 0.1;
	prmtrs->patch.tone.legacy_tuning = false;
	prmtrs->patch.noise.time = 0.1;
	prmtrs->patch.noise.period = 10;
	prmtrs->patch.noise_period_env.attack = 5;
	prmtrs->patch.noise_period_env.time = 0.1;
	prmtrs->patch.env.attack_time = 1;
	prmtrs->patch.env.hold1_level = 14;
	prmtrs->patch.env.inter1_time = 2;
	prmtrs->patch.env.hold2_level = 13;
	prmtrs->patch.env.inter2_time = 3;
	prmtrs->patch.env.hold3_level = 12;
	prmtrs->patch.env.decay_time = 4;
	prmtrs->patch.env.sustain_level = 11;
	prmtrs->patch.env.release = 5;
	prmtrs->patch.pitchenv.attack_pitch = 12;
	prmtrs->patch.pitchenv.time = 0.1;
	prmtrs->patch.ringmod.waveform[0] = 1;
	prmtrs->patch.ringmod.waveform[1] = 2;
	prmtrs->patch.ringmod.waveform[2] = 3;
	prmtrs->patch.ringmod.waveform[3] = 4;
	prmtrs->patch.ringmod.waveform[4] = 5;
	prmtrs->patch.ringmod.waveform[5] = 6;
	prmtrs->patch.ringmod.waveform[6] = 7;
	prmtrs->patch.ringmod.waveform[7] = 8;
	prmtrs->patch.ringmod.waveform[8] = 9;
	prmtrs->patch.ringmod.waveform[9] = 10;
	prmtrs->patch.ringmod.waveform[10] = 11;
	prmtrs->patch.ringmod.waveform[11] = 12;
	prmtrs->patch.ringmod.waveform[12] = 13;
	prmtrs->patch.ringmod.waveform[13] = 14;
	prmtrs->patch.ringmod.waveform[14] = 15;
	prmtrs->patch.ringmod.waveform[15] = 0;
	prmtrs->patch.ringmod.reset = true;
	prmtrs->patch.ringmod.phase = 0.1;
	prmtrs->patch.ringmod.loop = zynayumi::RingMod::Loop::Forward;
	prmtrs->ringmod_detune = 0.1;
	prmtrs->ringmod_transpose = 10;
	prmtrs->patch.ringmod.fixed_pitch = 10;
	prmtrs->patch.ringmod.fixed_vs_relative = 0.1;
	prmtrs->patch.ringmod.depth = 10;
	prmtrs->patch.buzzer.enabled = true;
	prmtrs->patch.buzzer.shape = zynayumi::Buzzer::Shape::UpSaw;
	...
	prmtrs->patch.seq.tempo = 100;
	prmtrs->patch.seq.host_sync = true;
	prmtrs->seq_beat_divisor = 16;
	prmtrs->seq_beat_multiplier = 10;
	prmtrs->patch.seq.loop = 0;
	prmtrs->patch.seq.end = 0;
	prmtrs->patch.lfo.shape = zynayumi::LFO::Shape::Triangle;
	prmtrs->patch.lfo.freq = 0.1;
	prmtrs->patch.lfo.delay = 10;
	prmtrs->patch.lfo.depth = 0.1;
	prmtrs->patch.portamento.time = 0.1;
	prmtrs->patch.portamento.smoothness = 0.9;
	prmtrs->patch.mixer.gain = 1;
	prmtrs->patch.mixer.pan[0] = 0.1;
	prmtrs->patch.mixer.pan[1] = 0.5;
	prmtrs->patch.mixer.pan[2] = 0.9;
	prmtrs->patch.control.pitchwheel = 4;
	prmtrs->patch.control.velocity_sensitivity = 0.1;
	prmtrs->patch.control.ringmod_velocity_sensitivity = 0.1;
	prmtrs->patch.control.noise_period_pitch_sensitivity = 0.1;
	prmtrs->patch.control.modulation_sensitivity = 0.1;

	// Program 1
	prmtrs = parameters_pts[1];
	prmtrs->patch.name = "Empty";

	// Program 2
	prmtrs = parameters_pts[2];
	prmtrs->patch.name = "Snare";
